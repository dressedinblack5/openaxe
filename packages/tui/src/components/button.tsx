...
export interface ButtonProps extends ComponentProps<"box">, Pick<ComponentProps<"button">, "children"> {
...
export function Button(props: ButtonProps) {
  ...
  return (
    <box {...rest} backgroundColor={variantStyle.backgroundColor} {...sizeStyle}>
