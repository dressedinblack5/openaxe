...
const CUSTOM_PROVIDER_OPTION_VALUE = "__openaxe_custom_provider__"
      ...
      description={() =>
        ({
          ...
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                OpenAxe Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://opencode.ai/go</span> and enable OpenAxe Go
              </text>
            </box>
          ),
