...
export const Definitions = {
  ...
  focus_next: keybind("tab", "Focus next pane"),
  focus_prev: keybind("shift+tab", "Focus previous pane"),
  focus_sidebar: keybind("ctrl+1", "Focus sidebar"),
  focus_messages: keybind("ctrl+2", "Focus messages"),
  focus_prompt: keybind("ctrl+3", "Focus prompt"),
