    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("dressedinblack5/tap/openaxe")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("openaxe")) return "openaxe"
          return ""
        },
      ),
