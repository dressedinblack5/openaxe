...
import { errors, PtyForbiddenError, PtyNotFoundError } from "../errors"
    ...
    HttpApiGroup.make("pty")
      .add(
        ...
        HttpApiEndpoint.put("update", PtyPaths.update, {
          ...
          error: errors(PtyNotFoundError, HttpApiError.BadRequest),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("connectToken", PtyPaths.connectToken, {
          ...
          error: errors(PtyForbiddenError, PtyNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
  ...
  HttpApiGroup.make("pty-connect")
    .add(
      ...
      HttpApiEndpoint.get("connect", PtyPaths.connect, {
        ...
        error: errors(HttpApiError.Forbidden, HttpApiError.NotFound),
      }).annotateMerge(
        OpenApi.annotations({
