...
import { errors, ApiNotFoundError, PermissionNotFoundError, SessionBusyError } from "../errors"
    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          error: errors(HttpApiError.BadRequest, ApiNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("resume", SessionPaths.resume, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          success: described(Schema.Boolean, "Resumed pending work"),
          error: errors(HttpApiError.BadRequest, ApiNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
            ...
            description:
              "Continue the interrupted pending work in a session. Returns false when the session has no pending work to resume.",
          }),
        ),
        ...
        HttpApiEndpoint.post("share", SessionPaths.share, {
          ...
          error: errors(HttpApiError.InternalServerError, ApiNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: errors(HttpApiError.BadRequest, ApiNotFoundError, SessionBusyError),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("permissionRespond", SessionPaths.permissions, {
          ...
          error: errors(HttpApiError.BadRequest, ApiNotFoundError, PermissionNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
