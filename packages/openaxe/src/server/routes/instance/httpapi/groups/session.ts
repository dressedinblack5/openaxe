    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("share", SessionPaths.share, {
          ...
          error: [HttpApiError.InternalServerError, ApiNotFoundError] as any,
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: [HttpApiError.BadRequest, ApiNotFoundError, SessionBusyError] as any,
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("permissionRespond", SessionPaths.permissions, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, PermissionNotFoundError] as any,
        }).annotateMerge(
          OpenApi.annotations({
