...
import { errors, McpServerNotFoundError } from "../errors"
    ...
    HttpApiGroup.make("mcp")
      .add(
        ...
        HttpApiEndpoint.post("authStart", McpPaths.auth, {
          ...
          error: errors(UnsupportedOAuthError, McpServerNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("authCallback", McpPaths.authCallback, {
          ...
          error: errors(HttpApiError.BadRequest, McpServerNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.delete("authRemove", McpPaths.auth, {
          ...
          error: errors(McpServerNotFoundError),
        }).annotateMerge(
          OpenApi.annotations({
